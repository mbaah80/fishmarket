          ...
          <div class="pd-detail">
            ...
            <div>
              <div class="pd-detail__inline">
                ...
                <span class="pd-detail__discount">(20% OFF)</span><del class="pd-detail__del">${{product.discountPrice}}</del></div>
            </div>
            ...
            <div class="u-s-m-b-15">
              ...
              <span class="pd-detail__preview-desc" v-html="product.productDescription"></span></div>
            <div class="u-s-m-b-15">
              <div class="pd-detail__inline">
                ...
                <div class="pd-detail-inline-2">
                  <div class="u-s-m-b-15">
                    ...
                    <div class="input-counter">
                      ...
                      <input class="input-counter__text input-counter--text-primary-style" v-model="quantity" type="text"  data-min="1" data-max="1000">

                      <span class="input-counter__plus fas fa-plus" @click="plusInput"></span></div>
                    <!--====== End - Input Counter ======-->
                  </div>
                  <div class="u-s-m-b-15">

                    <button class="btn btn--e-brand-b-2" @click="addToCart()">Add to Cart</button></div>
                </div>
              </div>
            </div>
            <div class="u-s-m-b-15">
            ...
            <div class="u-s-m-b-30">
              <div class="product-o product-o--hover-on">
                <div class="product-o__wrap">
                  ...
                  <router-link class="aspect aspect--bg-grey aspect--square u-d-block" to="/product/123">
                ...
                <span class="product-o__category">
                  ...
                  <router-link to="/product/123">Electronics</router-link></span>

                <span class="product-o__name">

                                            <router-link to="/product/123">Beats Bomb Wireless Headphone</router-link></span>
  ...
  methods: {
    ...
    addToCart() {
      let product = {
        ...
        userID: 'kshfskfhskfdsj'
      };
      firebase.firestore().collection('cart').where('product.id', '==', product.id)
          .get()
          .then((querySnapshot) => {
            ...
            firebase.firestore().collection('cart').add(product).then(() => {
              this.$notify({
